    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="px-4 sm:px-6 lg:px-8 py-6 space-y-6">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-5 h-32 animate-pulse"></div>
                <div className="bg-white rounded-lg border border-gray-200 p-5 h-64 animate-pulse"></div>
            </main>
        </div>
    );
}
