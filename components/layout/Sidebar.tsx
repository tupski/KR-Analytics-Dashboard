...
export default function Sidebar({ isMobileOpen = false, onClose, userEmail }: SidebarProps) {
    ...
    const desktopSidebar = (
        ...
        >
            {/* Logo (top) — always visible. Compact in collapsed mode. */}
            ...
            >
                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            <h1 className="text-sm font-bold text-gray-900 leading-tight">Kakarama</h1>
                            <p className="text-[10px] text-gray-500 leading-tight">Room Analytics</p>
                        </div>
                    </div>
                    <button
                        type="button"
